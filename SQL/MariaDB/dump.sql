...
--
-- Host: db
-- Generation Time: Jan 15, 2025 at 10:17 AM
...
--
-- Table structure for table `departures_log`
--

CREATE TABLE `departures_log` (
  `id` int(11) NOT NULL,
...
INSERT INTO `stops` (`id`, `name`, `sequence_number`) VALUES
(1, 'Tornimäe', 1),
(2, 'Lehmja', 2);
...
--
-- Indexes for table `departures_log`
--
ALTER TABLE `departures_log`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `departures_log`
--
ALTER TABLE `departures_log`
